...
function showGloria(mode){
 ...
 if(mode==="terrasse")b.innerHTML=`<div class="result-card"><h3>🌿 Glorias Genuss-Terrasse</h3><p><strong>Dienstag und Mittwoch geschlossen.</strong> Donnerstag bis Montag ist Abendessen nach Verfügbarkeit möglich. Bitte vorher anfragen.</p><div class="actions"><a href="sms:+436646437526?body=Hallo%20Zuhause%20am%20Bach,%20wir%20möchten%20ein%20Abendessen%20auf%20der%20Genussterrasse%20anfragen.">Abendessen anfragen</a></div></div>`;
